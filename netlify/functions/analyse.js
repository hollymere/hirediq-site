...
exports.handler = async function(event, context) {
  ...
  if (mode === 'rewrite') {
    const prompt = `You are HiredIQ. Rewrite this candidate's CV specifically for this role. Incorporate all missing keywords naturally. ASCII only, no smart quotes or em dashes.
Respond ONLY with this JSON:
{
  "ats_optimised_cv": "<full rewritten CV tailored for this role. Incorporate missing keywords naturally throughout. Use only these headers: Professional Summary, Work Experience, Education, Skills. Every section must be tailored to this specific role. Make it compelling and specific.>"
}
JOB: ${jd}
CV: ${cv}
